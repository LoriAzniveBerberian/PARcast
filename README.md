...
<table>
  <tr>
    <td colspan="2" width="100%">
      <img src="field_photos/skibeach_07142026.png" width="100%" alt="PARcast field deployment, Lake Tahoe, July 2026">
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center"><em>PARcast field deployment, Lake Tahoe, July 2026</em></td>
  </tr>
  <tr>
    <td width="50%">
      <img src="field_photos/KramersCove_1.png" width="100%" alt="Kramers Cove, Laguna, June 2026">
    </td>
    <td width="50%">
      <img src="field_photos/KramersCove2.png" width="100%" alt="Kramers Cove, Laguna, June 2026">
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center"><em>Kramers Cove, Laguna, June 2026</em></td>
  </tr>
</table>
...
## Acknowledgments
The final firmware and test sketches were adapted from example sketches provided by Arduino, Teensy/PJRC, and the maker communities behind each sensor library used in this project.

## AI Use Statement
PARcast's firmware and electronics design were developed iteratively with assistance from Anthropic's [Claude](https://claude.ai/) to explain concepts and debug circuits.
